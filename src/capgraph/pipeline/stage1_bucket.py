...
def _evidence_ticket(row: dict, sanitizer: LeakageSanitizer) -> Ticket:
    ...
    payload = {
        **row,
        ...
        # Sprint membership and the effort columns are final, unversioned snapshots
        # carried for the benchmark-v4 manifest and for audit. Nothing in profile
        # evidence may read them, so they are redacted here exactly as the final
        # assignee and the component names are.
        "sprint_id": None,
        "sprint_provenance": "redacted_unversioned_final_snapshot",
        "story_point": None,
        "timespent": None,
        "in_progress_minutes": None,
